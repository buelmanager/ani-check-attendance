        ...
        <div className="mb-6">
          <div className="relative">
            ...
            <input
              ...
              placeholder="학생 검색..."
              className="w-full bg-white border-2 border-gray-100 rounded-2xl pl-11 pr-4 py-3 text-primary placeholder-gray-400 focus:outline-none focus:border-primary shadow-sm"
            />
          </div>
        </div>
